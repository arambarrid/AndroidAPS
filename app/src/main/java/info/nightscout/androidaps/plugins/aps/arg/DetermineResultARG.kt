package info.nightscout.androidaps.plugins.aps.arg
...
class DetermineResultARG private constructor(injector: HasAndroidInjector) : APSResult(injector) {
    ...
    override fun newAndClone(injector: HasAndroidInjector): DetermineResultARG {
        val newResult = DetermineResultARG(injector)
        doClone(newResult)
